...
if(isset($_SESSION['uid'])) {
  echo "<body id='page-top'>
    ...
    <nav class='navbar navbar-expand-lg navbar-dark bg-primary fixed-top' id='sideNav'>
      <a class='navbar-brand js-scroll-trigger' href='#page-top'>
        <span class='d-blocak d-lg-none'>ABOUT ME</span>
      ...
      <div class='collapse navbar-collapse' id='navbarSupportedContent'>
        ...
        <li><form action='logout.php' method='post'>
          <button name='submit' type='submit'> Log Out
                   </button></li>
          <li class='nav-item'>
      ...
      <section class='resume-section p-3 p-lg-5 d-flex d-column' id='about'>
        <div class='my-auto'>
          ...
          <div class='subheading mb-5'>IBADAN, ILE-IFE NIGERIA 
            ...
            <a href='mailto:sollysamuel12@email.com'>sollysamuel12@gmail.com</a></p>
          </div>
      ...
      <section class='resume-section p-3 p-lg-5 d-flex flex-column' id='education'>
        <div class='my-auto'>
          ...
          <div class='resume-item d-flex flex-column flex-md-row mb-5'>
            ...
            <div class='resume-date text-md-right'>
              <span class='text-primary'>July 2015 - May 2018</span>
            </div>
          </div>
  ...
  echo "<h2 style='margin: 100px auto 0 0;'>Please <a href='form/form.php'><button style='cursor: pointer;' class='btn-md btn-primary'> LogIn </button></a>with Admin Password or send mail to <a href='mailto:witttechnologies@gmail.com'>Witt Technologies</a> For Permission.<br> <p style='margin: 120px 0 0 0; text-align: center;'> Click <a href='form/form.php'><button style='cursor: pointer;' class='btn-md btn-primary'> LogIn </button></a> to return to Home Page. Thanks.  </p> </h2>";
}
?>